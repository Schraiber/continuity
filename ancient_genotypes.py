...
def compute_GT_like(reads,freq,t1,t2):
	...
	return per_site_like

#TODO:For actual likelihood, should have a dictionary of genotype likelihoods corresponding to each frequency, so don't need to compute *too many* matrix Exponentials
